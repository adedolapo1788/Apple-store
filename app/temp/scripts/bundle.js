...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.siteHeader = (0, _jquery2.default)('.main-header');
		this.menuIcon = (0, _jquery2.default)('.main-header__menu-icon');
		this.menuContent = (0, _jquery2.default)(".main-header__menu-content");
		this.events();
	}
